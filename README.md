...
1. [XOR with TensorFlow.](./xor_with_tensorflow.py)
   ...
   [Blog link.](https://www.yueye.org/2017/xor-with-tensorflow.html)

2. [FizzBuzz with TensorFlow.](./fizzbuzz_with_tensorflow.py)

   [Blog link.](https://www.yueye.org/2017/fizzbuzz-with-tensorflow.html)

3. [Plot Mask on Image.](./plot_mask_on_image.py)

   [Blog link.](https://www.yueye.org/2017/plot-mask-on-image.html)
...
4. [Visualize outputs of intermediate layers of a Keras model. (Method 1)](./visualize_outputs_keras_model1.py)
   ...
   [Blog link.](https://www.yueye.org/2017/visualize-the-output-of-intermediate-layers-of-a-keras-model.html)
...
5. [TensorFlow Dataset with pre-reading image data in numpy array.](./tf_dataset_samples/ds_numpy.py)
   ...
   [Blog link.](https://www.yueye.org/2018/memo-of-tensorflow-dataset.html)

6. [Convert custom own dataset to pascal_voc format.](./convert_to_pascal_voc.py)

   [Blog link.](https://www.yueye.org/2018/convert-your-own-custom-dataset-to-pascal-voc.html)
...
7. [Plot Chinese characters on images. (using Matplotlib)](./plot_chinese_matplotlib.py)
   ...
   [Blog link.](https://www.yueye.org/2018/plot-chinese-characters-on-images.html)

8. [Convert dataset to COCO json format to train models using Detectron](./convert_to_detectron_json.py)

   [Blog link.](https://www.yueye.org/2018/train-object-detection-model-using-detectron.html)